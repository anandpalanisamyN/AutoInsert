...
pool
  ...
  .then(() => {
    ...
    const datas = [
      {
        ...
        status_id: 2,
        lifetime: '2024-04-15 00:00:00.000',
        scheduled_on: '2024-04-16 00:00:00.000',
    ...
    const insertQuery = `
   INSERT INTO post (user_id, title, subtitle, cover_image_link, content_link, status_id, lifetime, scheduled_on, published_date_time, archived_date_time, created_date_time)
   VALUES (@user_id, @title, @subtitle, @cover_image_link, @content_link, @status_id, @lifetime, @scheduled_on, @published_date_time, @archived_date_time, @created_date_time)
 `;
